    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-20">
          ...
          {/* ── Visual side ── */}
          <SectionReveal variants={scaleIn} className="w-full md:w-1/2 relative">
            {/* Rotating ring */}
            <motion.div
              animate={{ rotate: 360 }}
            ...
            <div className="aspect-square bg-linear-to-tr from-[#1a0505] via-brand-saffron/10 to-brand-saffron/25 rounded-full flex items-center justify-center p-8 overflow-hidden relative">
              <div
              ...
              <div className="text-center relative z-10 select-none">
                <h3 className="text-7xl font-bold text-white tracking-tight mb-1">
                  Alpha
                </h3>
                <h3 className="text-5xl font-light text-brand-saffron tracking-widest">
                  Matrix
                </h3>
              </div>
            </div>
          ...
          >
            <motion.div variants={fadeLeft} className="flex items-center space-x-4 mb-8">
              <h2 className="text-xs tracking-[0.3em] text-brand-saffron uppercase font-bold">
                About Us
              </h2>
            ...
            <motion.p
              variants={fadeUp}
              className="text-gray-400 text-lg font-light leading-relaxed mb-6"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="border border-brand-saffron text-brand-saffron hover:bg-brand-saffron hover:text-white px-8 py-3 rounded text-sm font-bold tracking-widest uppercase transition-colors duration-300"
            >
              Join the Matrix
            </motion.button>
          </motion.div>
        ...
        {/* ── Stats row — staggered ── */}
        <motion.div
          className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-px border border-white/5 rounded-xl overflow-hidden"
        ...
        >
          {stats.map((s) => (
            <motion.div
              key={s.label}
              variants={fadeUp}
              className="bg-white/2.5 px-8 py-10 text-center hover:bg-white/5 transition-colors duration-300"
            >
